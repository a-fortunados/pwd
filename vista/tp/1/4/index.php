...
<div class="container-main">
    <div class="row">
        <div class="col">
            <form class="row g-3 needs-validation" novalidate id="form4" name="form4" method="post" action="mostrarDatos.php">
                <div>
                ...
                <input class="btn btn-warning" id="eje4" name="eje4" type="submit" value="Enviar">
            </form>
        </div>
    </div>
</div>
